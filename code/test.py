...
train_en = load_data("/kaggle/input/datasets/haaasini/talks-corpus/train.en")

train_fr = load_data("/kaggle/input/datasets/haaasini/talks-corpus/train.fr")
...
# Example usage
test_en = load_data("/kaggle/input/datasets/haaasini/talks-corpus/test.en")  # Load raw test data
...
test_fr = load_data("/kaggle/input/datasets/haaasini/talks-corpus/test.fr")  # Load raw test data
...
print(device)
model = load_model_from_state_dict(lambda: model, "/kaggle/working/scratch_transformer_model.pth", device)
