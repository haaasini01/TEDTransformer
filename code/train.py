...
val_en = load_data("/kaggle/input/datasets/haaasini/talks-corpus/dev.en")  # Load raw test data
...
val_fr = load_data("/kaggle/input/datasets/haaasini/talks-corpus/dev.fr")  # Load raw test data
